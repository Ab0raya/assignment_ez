import 'package:assignments/Login_and_register_screens/login_view.dart';
        ...
        children: [
          ...
          Align(
            ...
            child: ListView(
              children: [
                const CustomField(
                    label: 'Full name', icon: Icons.person, topPadding: 350),
                const CustomField(
                    label: 'Email',
                    icon: Icons.email,
                    topPadding: 20),
                const CustomField(
                    label: 'Number', icon: Icons.tag, topPadding: 20),
                const CustomField(
                    label: 'Password',
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      customText("already have an account !", Colors.grey),
                      InkWell(
                        onTap: (){
